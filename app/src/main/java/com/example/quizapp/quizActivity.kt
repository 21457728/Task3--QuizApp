...
class quizActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      //  list.add(QuestionModel("Who is the PM of India", "modi","rahul","kejriwal","amitsha" ,"modi"))
        //list.add(QuestionModel("Who is the PM of India", "rahul","modi","kejriwal","amitsha" ,"modi"))
        //list.add(QuestionModel("Who is the PM of India", "modi","rahul","kejriwal","amitsha" ,"modi"))
        //list.add(QuestionModel("Who is the PM of India", "rahul","modi","kejriwal","amitsha" ,"modi"))
